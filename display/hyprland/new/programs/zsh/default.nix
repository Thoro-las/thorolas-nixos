...

{
  programs.zsh = {
    ...
    shellAliases = {
      ...
      edeww = "sudo -E nvim /etc/nixos/display/hyprland/new/programs/eww/new-eww/";
      cateww_bar = ''
        printf "I am on nix-os system, using hyprland, and I am using eww for my top bar.\n\nI have this eww.yuck:\n%s\n\nAnd this eww.scss:\n%s\n" \
        "$(cat /etc/nixos/display/hyprland/new/programs/eww/new-eww/bar/eww.yuck)" \
        "$(cat /etc/nixos/display/hyprland/new/programs/eww/new-eww/bar/eww.scss)" | wl-copy
      '';
    };
  ...
  home.sessionVariables = {
    hypr = "/etc/nixos/display/hyprland/new/hyprland/";
    programs = "/etc/nixos/display/hyprland/new/programs/";
  };
